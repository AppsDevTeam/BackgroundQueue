...
class Queue {
	...
	private static function logException($errorMessage, $entity, $state, $originalErrorMessage, \Exception $originalException)
	{
		if ($originalException) {
			\Tracy\Debugger::log($originalException, ILogger::EXCEPTION);
		}
